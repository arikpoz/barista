...
/**
 * This class extends the {@link TreeTableView} to use items as a data source.
 * <p/>
 * This allows you to treat a {@link TreeTableView} in a similar way as a {@link javafx.scene.control.ListView} or {@link javafx.scene.control.TableView}.
 * <p/>
...
public class TreeTableViewWithItems<T extends HierarchyData<T>> extends TreeTableView<T> {
    ...
    private TreeItem<T> addRecursively(T value) {
        ...
        // items are not expanded, uncomment this if you want them to be expanded
